            ...
            if (itemRap?.maCumRap === openRight?.maCumRap) { 
                menuUpMobile.push(
                        <div className="d-flex menu-he-thong-rap-item poiter" key={index}>
                            <div>
                                <img className='mr-2' src={objLichChieuHeThongRap.logo} alt={objLichChieuHeThongRap.tenHeThongRap} width={50} height={50}/>
                            </div>
                            <div>
                                <div>
                                    <p className='m-0 text-menu-trang-chu-item font-weight-bold'>
                                        <span className='text-success'>{tenCumRap[0]}</span> - <span className='text-dark'>{tenCumRap[1]}</span>
                                    </p>
                                    <p className='m-0 text-menu-trang-chu-item text-dark' data-toggle="tooltip" title={itemRap.diaChi}>Địa chỉ: {itemRap.diaChi}</p>
                ...
                menuDownMobile.push(
                    <div className="d-flex menu-he-thong-rap-item gach-duoi-menu-he-thong-rap-item  poiter" key={index} onClick={()=>{setOpenRight(itemRap);setToggle(toggle => !toggle)}}>
                        <div>
                            <img className='mr-2' src={objLichChieuHeThongRap.logo} alt={objLichChieuHeThongRap.tenHeThongRap} width={50} height={50}/>
                        </div>
                        <div>
