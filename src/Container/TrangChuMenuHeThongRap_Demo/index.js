...
export default function HeThongRapDemo(props) {
    ...
    return (
        <Element name='cumRap' className='container border-menu-he-thong-rap-item my-5'>
            <div className="row d-none d-md-flex">
                <div className="col-12 col-lg-1 d-flex d-lg-block p-0">
                    {heThongRap?.map((item,index) => {
                        ...
                        return (
                        <div className={`menu-he-thong-rap-item gach-duoi-menu-he-thong-rap-item poiter ${activeItem}`} key={index} onClick = {() => setOpenRight(item.maHeThongRap)}> 
            ...
            <div className="row d-block d-md-none">
                <div className="d-flex p-0 w-100">
                    {heThongRap?.map((item,index) => {
                        ...
                        return (
                        <div  className = {`menu-he-thong-rap-item gach-duoi-menu-he-thong-rap-item poiter ${activeItem}`} key={index} onClick = {() => setOpenRight(item.maHeThongRap)}> 
                            <img src={item.logo} alt={item.tenHeThongRap} width={35} height={35}/>
                        </div>
                        )
                    })}
                </div>
