        ...
        <div className="dang-nhap">
            <div className='form-dang-nhap text-light'>
                ...
                <form onSubmit = {(e) => handleSubmit(e)}>
                    ...
                    <div className='form-group py-1'>
                        <input className='form-control' name='xacNhanMatKhau' type="password" placeholder='Xác nhận mật khẩu ' onBlur = {(e) =>handleBlur(e)} onChange={(e) =>handleChange(e)}/>
                    ...
                    <div>
                        <p>Nếu bạn đã có tài khoản. Vui lòng bấm <NavLink to='/dangnhap'>đăng nhập</NavLink>.</p>
                    </div>
                </form>
            </div>
        </div>
