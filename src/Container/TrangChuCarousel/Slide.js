    ...
    return (
      <>
        ...
        >
          ...
          >
            <div className="slideContentInner" onClick={() => setOpen(true)} style={{ cursor: "pointer",}}>
        ...
        <ModalVideo channel="youtube" autoplay isOpen={isOpen} videoId={layIdTrailer()} onClose={() => setOpen(false)}/>
      </>
    );
  }
